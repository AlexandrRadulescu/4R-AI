...
`timestamp_s` is seconds into the **video file**, not match clock. Pause in any
player and write down the time. No annotation tool needed.
...
Residual Block (dilation=16)
        │
        ▼
Residual Block (dilation=32)
        │
        ▼
Prediction Head
        │
        ▼
Goal / Shot / Card scores
